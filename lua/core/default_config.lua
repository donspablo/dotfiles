...
M.options = {
   ...
   donPabloNow = {
      ...
      -- updater
      update_url = "https://github.com/donPabloNow/dotfiles",
      update_branch = "main",
   },
}
...
M.ui = {
   ...
   -- For Ex : if you have onedark set in donPabloNow, set onedark's bg color on your terminal
   transparency = false,
}
...
M.mappings.plugins = {
   ...
   telescope = {
      ...
      live_grep = "<leader>fw",
      oldfiles = "<leader>fo",
      themes = "<leader>th", -- DonPabloNow theme picker
   },
}
