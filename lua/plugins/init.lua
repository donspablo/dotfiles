...
return packer.startup(function()
   ...
   -- this is the donPabloNow core repo containing utilities for some features like theme swticher, no need to lazy load
   use "DonPabloNow/extensions"
